...
const EquiposPage = () => {
  ...
  return (
    <div className="p-6 min-h-screen bg-gradient-to-tr from-black via-indigo-900 to-purple-900 text-white font-orbitron">
      <h2 className="text-4xl font-extrabold mb-8 text-center drop-shadow-lg">
        Equipos y Participantes
      </h2>

      <motion.div
        className="max-w-lg mx-auto mb-8 p-6 rounded-xl bg-gradient-to-tr from-black via-indigo-900 to-purple-900 shadow-xl flex flex-col items-center"
      ...
      >
        ...
        <select
          id="teamFilter"
          className="w-full p-3 rounded-lg text-black font-medium cursor-pointer border-0 ring-0 focus:ring-4 focus:ring-purple-400 transition-shadow"
          value={selectedTeam}
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="DialogContent" aria-describedby={undefined}>
            ...
            <div className="flex gap-4 mt-6 justify-center">
              <button
                className="bg-red-600 text-white px-4 py-2 rounded-lg hover:scale-110 focus:ring-2 focus:ring-red-400 transition"
                onClick={confirmDelete}
              >
                Sí, eliminar
              </button>
              <button
                className="bg-gray-400 text-black px-4 py-2 rounded-lg hover:scale-110 focus:ring-2 focus:ring-gray-300 transition"
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="DialogContent">
            ...
            <div className="flex justify-center mt-6">
              <button
                className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:scale-110 focus:ring-2 focus:ring-blue-400 transition"
